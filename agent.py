...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 1 / self.trial_number

            self.trial_number = self.trial_number + 1
            self.epsilon = math.fabs(math.cos(self.alpha * self.trial_number))
        ...
        if not self.learning:
            ...
            if random.random() < self.epsilon :
                ...
                for action in self.Q[state]:
                    if maxQ == self.Q[state][action]: #break ties
                        valid.append(action)
...
def run():
    ...
    #sim.run(n_test=10)
    sim.run(n_test=150, tolerance=0.001)
